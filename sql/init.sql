...
VALUES (1, NULL, '用户菜单', '用户菜单', NULL, 0, '2021-08-23 16:15:15');
INSERT INTO `ss_authority`
VALUES (101, 1, '菜单1', '菜单1', NULL, 0, '2021-08-23 16:15:36');
INSERT INTO `ss_authority`
VALUES (102, 1, '菜单2', '菜单2', NULL, 0, '2021-08-23 16:15:54');
INSERT INTO `ss_authority`
VALUES (10101, 101, '问好', '菜单1功能：问好', 'api:hello', 1, '2021-08-23 16:18:01');
INSERT INTO `ss_authority`
VALUES (10201, 102, '用户名', '菜单2功能：输出用户名', 'user:name', 1, '2021-08-23 17:02:08');
INSERT INTO `ss_authority`
VALUES (2, NULL, '用户角色', '用户角色', 'ROLE_USER', 2, '2021-08-23 17:02:08');
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 9
  DEFAULT CHARSET = utf8mb4 COMMENT ='权限—角色关联表';

-- ----------------------------
-- Records of ss_authority_role_rel
-- ----------------------------
BEGIN;
INSERT INTO `ss_authority_role_rel`
VALUES (1, 1, 1);
INSERT INTO `ss_authority_role_rel`
VALUES (2, 101, 1);
INSERT INTO `ss_authority_role_rel`
...
BEGIN;
INSERT INTO `ss_role`
VALUES (1, 'ADMIN', '超级管理员', '2021-08-23 16:08:02');
INSERT INTO `ss_role`
VALUES (2, 'USER', '用户', '2021-08-23 16:08:02');
COMMIT;
...
BEGIN;
INSERT INTO `ss_user`
VALUES (1, 'user', '{bcrypt}$2a$10$jhS817qUHgOR4uQSoEBRxO58.rZ1dBCmCTjG8PeuQAX4eISf.zowm', 1);
INSERT INTO `ss_user`
VALUES (2, 'test', '{bcrypt}$2a$10$jhS817qUHgOR4uQSoEBRxO58.rZ1dBCmCTjG8PeuQAX4eISf.zowm', 1);
COMMIT;
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb4
  ROW_FORMAT = DYNAMIC COMMENT ='用户-角色关联表';
